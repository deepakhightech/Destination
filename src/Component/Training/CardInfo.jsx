...
const Cardinfo = ({ title, intro, closingText, buttonText }) => {
  const cards = [
    {
      image:
  ...
  return (
    <div className="w-full py-10 px-4 md:px-20 text-center">
      ...
      {/* Intro Paragraph */}
      <p className="text-gray-300 text-lg  md:text-lg mb-8">{intro}</p>
      ...
      {/* Closing Paragraph */}
      <p className="text-gray-300 text-lg md:text-lg mt-8">{closingText}</p>
